...
        { id: "u_admin", name: "import * as Papa from "papaparse";
...
`;מנהל מערכת", email: "admin@system.com", password: "admin123", role: "admin", profession: "מנהל", joinedAt: new Date(Date.now() - 86400000 * 30).toISOString() },
