                        ...
                        <div className="fade">
                            ...
                            <div style={{ display: "flex", gap: 15, marginBottom: 24 }}>
                                ...
                                <div className="card" style={{ flex: 1, padding: "24px 20px", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", border: "1px solid rgba(56,189,248,0.3)", background: "rgba(56,189,248,0.03)" }}>
                                    ...
                                    <input ref={aiFileInputRef} type="file" accept=".pdf,.txt" style={{ display: "none" }} onChange={e => addLibraryDoc(e.target.files)} />
                                </div>
                            ...
                            {/* אזור התצוגה המשותף: שתי הרשימות תמיד מופיעות */}
                            <div style={{ display: "flex", gap: 20, flexDirection: "column" }}>
                                
                                {/* 1. רשימת המסמכים (PDF) בספרייה */}
                                <div>
                                ...
                                {/* 2. רשימת המבחנים במערכת (מ-CSV או מ-AI) */}
